...
class Database:
    ...
    def view_books(self):
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\books.csv", mode='r') as file:
    ...
    def authenticate(self, stud_id, stud_password):
        ...
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\students.csv", mode='r', encoding='utf-8') as file:
            csv_file = csv.reader(file)
            for lines in csv_file:
                try:
    ...
    def save_student(self, stud_obj):
        ...
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\students.csv", newline='', mode='a', encoding='utf-8') as file:
            writer_object = csv.writer(file)
            writer_object.writerow(data)

    # This method allows thee student to borrow a book.
    def borrow_book(self, stud_obj, book_id):
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\books.csv", mode='r', encoding='utf-8') as file:
            books = csv.reader(file)
            success = False

            with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\temp.csv", mode='a', newline='', encoding='utf-8') as temp_file:
                for book in books:
                    try:
                        if book[0] == book_id:
                            if int(book[6]) >= 1:
        ...
        os.remove("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\books.csv")
        os.rename("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\temp.csv", "C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\books.csv")
    ...
    def update_all_borrows_file(self,stud_obj, book_obj):
        ...
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\temp.csv", mode='w', newline='', encoding='utf-8') as temp_file:
            temp_file_writer = csv.writer(temp_file)

            with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\all_borrows.csv", mode='r', encoding='utf-8') as borrow_file:
        ...
        os.remove("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\all_borrows.csv")
        os.rename("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\temp.csv", "C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\all_borrows.csv")
    ...
    def fetch_last_transaction_id(self):
        last = []
        lines = []
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\all_transactions.csv", mode='r', encoding='utf-8') as file:
            csv_file = csv.reader(file)
            for lines in csv_file:
                if len(lines) > 0:
                    last = lines
    ...
    def write_to_transaction_and_borrow_file(self, stud_obj, book_obj, trans_type):
        ...
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\all_transactions.csv", mode='a', newline='', encoding='utf-8') as file:
        ...
        if trans_type == 'b':
            with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\all_borrows.csv", mode='a', newline='', encoding='utf-8') as borrow_file:
            ...
            for line in borrow_file_reader:
                try:
                    if line[1] == stud_obj.student_id:
                        ...
                        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\books.csv", mode='r', encoding='utf-8') as book_file:
    ...
    def deregister(self, student_obj):
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\students.csv", mode='r', newline='', encoding='utf-8') as file_read_obj:
            csv_reader = csv.reader(file_read_obj)

            with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\temp.csv", mode='w', newline='', encoding='utf-8') as file_write_object:
        ...
        os.remove("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\students.csv")
        os.rename("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\temp.csv", "C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\students.csv")

    # This method is used to get the last librarian id.
    def fetch_last_librarian_id(self):
        last = []
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\librarian.csv", mode='r', encoding='utf-8') as file:
            csv_file = csv.reader(file)
            lines = []
            for lines in csv_file:
                if len(lines) > 0:
    ...
    def save_librarian(self, lib_obj):
        ...
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\librarian.csv", newline='', mode='a', encoding='utf-8') as file:
            writer_object = csv.writer(file)
            writer_object.writerow(data)
    ...
    def save_book(self, book_obj):
        ...
        with open("C:\\Users\\skshu\\OneDrive\\Documents\\PROJECTS\\Library Management System 1\\Data\\books.csv", newline='', mode='a', encoding='utf-8') as file_obj:
